...
`universal-waveform-explorer` is a TypeScript-based project within ORGAN-II (Poiesis) of the organvm eight-organ creative-institutional system. The project needed a technology foundation that balances rapid prototyping with long-term maintainability.
